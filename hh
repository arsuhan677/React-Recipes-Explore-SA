...
function Home(props) {
  return (
    <div className="bg-white border border-white shadow-sm mx-5 sm:mx-auto max-w-5xl py-8 px-5 sm:px-10 my-12 rounded-2xl">
      <div className="mb-6 sm:mb-10">
        <p className="text-[18px] sm:text-[20px] uppercase text-green-400 mb-2 sm:mb-4">
          Welcome
        </p>
